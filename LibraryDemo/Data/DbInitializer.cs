            ...
            _builder.Entity<Book>(b =>
            {
                b.HasData(new Book
                {
                    ...
                    Metadata = new BookMetadata
                    {
                        ...
                        ISBN = "978-0439708180",
                        Rating = 5,
                        PublisherReleaseDate = new DateTime(1998, 9, 1)
                    }.ToJson()
                });
                b.HasData(new Book
                {
                    ...
                    Metadata = new BookMetadata
                    {
                        ...
                        ISBN = "978-0439064873",
                        Rating = 5,
                        PublisherReleaseDate = new DateTime(2000, 9, 1)
                    }.ToJson()
                });
                b.HasData(new Book
                {
                    ...
                    Metadata = new BookMetadata
                    {
                        ...
                        ISBN = "978-1451648539",
                        Rating = 4.5,
                        PublisherReleaseDate = new DateTime(2011, 10, 24)
                    }.ToJson()
                });
            });
        }
